...
begin
	...
	gd = "C:/Users/dusty/Documents/PlaymatProjects/PlaymatGames/Mage"

	USER_SETTINGS = deserialize("$gd/tmp/user_selection.jls")
	
	DECKS_DIR = "C:/Users/dusty/Documents/PlaymatProjects/PlaymatGames/Mage/EDH/decks"
...
md"""
Mage.jl Deck directory path: $(@bind DECK_DIR Select(DECKS_DIR |> readdir))
"""
...
begin
	custom_imgs_dir = "$DECKS_DIR/$DECK_NAME/custom_images/"
...
deck = deserialize("$DECKS_DIR/$DECK_DIR/$DECK_NAME.jls")
...
if ((@isdefined save_v) && save_v) || ((@isdefined save_h) && save_h)
	serialize("$DECKS_DIR/$DECK_DIR/$DECK_NAME.jls", deck)
end
